/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b0ccaf8040943cbff6411241392c916c)
// Runtime types generated with workerd@1.20260430.1 2026-04-21 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
	}
	interface Env {
		AUCTION_IMAGES: R2Bucket;
		d1: D1Database;
		AUCTION_COLLECTOR_VERSION: "2026.04.06.2";
		AUCTION_MINIMUM_RUNNER_VERSION: "2026.04.06.2";
		AUCTION_BASE_URL: string;
		HOST: string;
		PORT: string;
		AUCTION_ADMIN_PASSWORD: string;
		BETTER_AUTH_SECRET: string;
		AUCTION_INGEST_TOKEN: string;
		AUCTION_ADMIN_EMAILS: string;
		AUCTION_TRUSTED_ORIGINS: string;
		AUCTION_USE_SECURE_COOKIES: string;
		AUCTION_COLLECTOR_PRIVATE_KEY_FILE: string;
		AUCTION_COLLECTOR_PUBLIC_KEY_FILE: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUCTION_COLLECTOR_VERSION" | "AUCTION_MINIMUM_RUNNER_VERSION" | "AUCTION_BASE_URL" | "HOST" | "PORT" | "AUCTION_ADMIN_PASSWORD" | "BETTER_AUTH_SECRET" | "AUCTION_INGEST_TOKEN" | "AUCTION_ADMIN_EMAILS" | "AUCTION_TRUSTED_ORIGINS" | "AUCTION_USE_SECURE_COOKIES" | "AUCTION_COLLECTOR_PRIVATE_KEY_FILE" | "AUCTION_COLLECTOR_PUBLIC_KEY_FILE" | "VAPID_PUBLIC_KEY" | "VAPID_PRIVATE_KEY" | "VAPID_SUBJECT">> {}
}
